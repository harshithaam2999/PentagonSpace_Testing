...
public class WebDriverUtility 
{
	...
	public void toperformScreenshotOnWebpage(WebDriver driver,String img) throws IOException {
		TakesScreenshot ts=(TakesScreenshot) driver;
		File scr = ts.getScreenshotAs(OutputType.FILE);
		File f=new File("./ErrorShots/"+img+".png");
		org.openqa.selenium.io.FileHandler.copy(scr, f);
	}
